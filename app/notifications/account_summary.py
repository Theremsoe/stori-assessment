...
<img alt="Stori" loading="lazy" width="155.04" height="47.86" decoding="async" style="color:transparent" src="https://www.storicard.com/_next/static/media/complete-logo.0f6b7ce5.svg">

"""

    send(markdown, subject='Stori assessment (Julio)',
         from_email='theremsoe@gmail.com', to_email=email, smtp=EmailConfig().model_dump())
